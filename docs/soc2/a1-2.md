...
## Points of Focus
### A1.2.a: Identifies Environmental Threats
Assesses environmental risks to systems.
### A1.2.b: Designs Detection Measures
Implements detection for environmental events.
### A1.2.c: Implements and Maintains Environmental Protection Mechanisms
Prevents and mitigates environmental events.
### A1.2.d: Implements Alerts to Analyze Anomalies
Communicates alerts for environmental threats.
### A1.2.e: Responds to Environmental Threat Events
Has procedures for environmental threats.
### A1.2.f: Communicates and Reviews Detected Environmental Threat Events
Reports events to management.
### A1.2.g: Determines Data Requiring Backup
Evaluates data backup requirements.
### A1.2.h: Performs Data Backup
Implements backup procedures and monitors failures.
### A1.2.i: Addresses Offsite Storage
Stores backups at appropriate distance from primary location.
### A1.2.j: Implements Alternate Processing Infrastructure
Implements redundancy and failover capabilities.
### A1.2.k: Considers Data Recoverability
Identifies and mitigates threats to data recovery.
## Mapped SCF controls
